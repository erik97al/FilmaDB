...
echo '</li>';
echo '<li class="nav-item">';
echo '<a class="nav-link active" href="myWatchlist.php">Watchlist</a>';
echo '</li>';
echo '<li class="nav-item">';
...
echo '</nav>';
	...
	$results = getFromWatchlist($conn, $username);

	echo "<h1>Watchlist e ".$username."</h1><br><br>";
