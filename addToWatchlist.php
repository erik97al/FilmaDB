...
echo '</nav>';
	...
	$movieId = $_POST["id"];
        ...
        if(checkWatchList($conn, $username, $movieId))
        {
        echo "<h3>Filmi ekziston n&euml watchlist!</h3><br>";
        echo "<a href=\"main.php\">Kthehu tek K&eumlrkimi</a>";
        }
        else
        {
        addToWatchList($conn, $username, $movieId);
        echo "<h3>Filmi u shtua me sukses n&euml watchlist!</h3><br>";
        echo "<a href=\"main.php\">Kthehu tek K&eumlrkimi</a>";  
        }
